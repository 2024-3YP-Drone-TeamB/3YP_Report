...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|c|c|c|}
        ...
        \hline
    \end{tabular}
    \caption[Comparison of LWIR thermal cameras]{Comparison of LWIR thermal camera models used in previous studies. Prices are approximate and based on various retail or supplier listings.}
