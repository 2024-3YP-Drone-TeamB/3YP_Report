...
\begin{table}[H]
    ...
    \textbf{FLIR Vue Pro\footnotemark[\numexpr\value{fnstart}+1\relax]} 
    & 640 × 512 & < 50 & 
    \begin{tabular}[c]{@{}c@{}}9 mm: 69° × 56° \\ 13 mm: 45° × 37° \\ 19 mm: 32° × 26° \end{tabular} 
    & 92–113.4 & 3895 (USD)\footnotemark[\numexpr\value{fnstart}+2\relax] \\
    \hline

    \multirow{2}{*}{\textbf{FLIR Duo Pro R\footnotemark[\numexpr\value{fnstart}+3\relax]}} 
    & 640 × 512 & < 50 & 
    \begin{tabular}[c]{@{}c@{}}13 mm: 45° × 37° \\ 19 mm: 32° × 26° \\ 25 mm: 25° × 20° \end{tabular} 
    & 325–375 & 6599 (USD)\footnotemark[\numexpr\value{fnstart}+4\relax] \\
    \cline{2-6}
    & 336 × 256 & < 50 & 
    \begin{tabular}[c]{@{}c@{}}9 mm: 35° × 27° \\ 13 mm: 25° × 19° \\ 19 mm: 17° × 13° \end{tabular} 
    & 325 & 4499 (USD)\footnotemark[\numexpr\value{fnstart}+5\relax] \\
    \hline

    \textbf{FLIR One Pro\footnotemark[\numexpr\value{fnstart}+6\relax]} 
    & 160 × 120 & 70 & 50° × 43° & 36.5 & 349 (GBP)\footnotemark[\numexpr\value{fnstart}+7\relax] \\
    \hline

    \textbf{FLIR One Edge Pro\footnotemark[\numexpr\value{fnstart}+8\relax]} 
    & 160 × 120 & 70 & 54° × 42° & 153 & 435 (GBP)\footnotemark[\numexpr\value{fnstart}+9\relax] \\
    \hline

    \textbf{FLIR Tau 2\footnotemark[\numexpr\value{fnstart}+10\relax]} 
    & 640 × 512 & < 30 & 
    \begin{tabular}[c]{@{}c@{}}7.5 mm: 90° × 69° \\ 9 mm: 69° × 56° \\ 13 mm: 45° × 37° \\ 19 mm: 32° × 26° \end{tabular} 
    & 72 & 6813 (USD)\footnotemark[\numexpr\value{fnstart}+11\relax] \\
    \hline

    \multirow{2}{*}{\textbf{DJI Zenmuse XT\footnotemark[\numexpr\value{fnstart}+12\relax]}} 
    & 640 × 512 & < 50 & 
    \begin{tabular}[c]{@{}c@{}}7.5 mm: 90° × 68° \\ 9 mm: 69° × 56° \\ 13 mm: 45° × 37° \\ 19 mm: 32° × 26° \end{tabular} 
    & 270 & 9900 (USD)\footnotemark[\numexpr\value{fnstart}+13\relax] \\
    \cline{2-6}
    & 336 × 256 & < 50 & 
    \begin{tabular}[c]{@{}c@{}}6.8 mm: 49.1° × 37.4° \\ 9 mm: 35° × 27° \\ 13 mm: 25° × 19° \\ 19 mm: 17° × 13° \end{tabular} 
    & 270 & 7999 (USD)\footnotemark[\numexpr\value{fnstart}+14\relax] \\
    \hline

    \end{tabular}
\end{table}

\footnotetext[\numexpr\value{fnstart}+1\relax]{\url{https://flir.netx.net/file/asset/10907/original/attachment}}
\footnotetext[\numexpr\value{fnstart}+2\relax]{\url{https://groupgets.com/products/flir-vue-pro}}
\footnotetext[\numexpr\value{fnstart}+3\relax]{\url{https://flir.netx.net/file/asset/8136/original/attachment}}
\footnotetext[\numexpr\value{fnstart}+4\relax]{\url{https://www.tequipment.net/FLIR/DUO-PRO-R-640-19mm-9Hz/UAVs-and-Drones/}}
\footnotetext[\numexpr\value{fnstart}+5\relax]{\url{https://dronedoctorusa.com/products/flir-duo-pro-r-336-30hz-19mm-open-box}}
\footnotetext[\numexpr\value{fnstart}+6\relax]{\url{https://flir.netx.net/file/asset/14770/original/attachment}}
\footnotetext[\numexpr\value{fnstart}+7\relax]{\url{https://www.flir.co.uk/products/flir-one-pro/?model=435-0006-03&vertical=condition+monitoring&segment=solutions}}
\footnotetext[\numexpr\value{fnstart}+8\relax]{\url{https://flir.netx.net/file/asset/5631/original/attachment}}
\footnotetext[\numexpr\value{fnstart}+9\relax]{\url{https://www.flir.co.uk/products/flir-one-edge-pro/}}
\footnotetext[\numexpr\value{fnstart}+10\relax]{\url{https://www.unmannedsystemstechnology.com/wp-content/uploads/2012/04/FLIR-Tau2-Brochure.pdf}}
\footnotetext[\numexpr\value{fnstart}+11\relax]{\url{https://www.thermalvideo.com/46640001x.htm}}
\footnotetext[\numexpr\value{fnstart}+12\relax]{\url{https://www.dji.com/uk/zenmuse-xt/specs}}
\footnotetext[\numexpr\value{fnstart}+13\relax]{\url{https://www.thedroneproshop.com/blogs/product-info/dji-zenmuse-xt-specifications}}
\footnotetext[\numexpr\value{fnstart}+14\relax]{\url{https://www.bhphotovideo.com/c/product/1318086-REG/dji_cp_zm_000337_zenmuse_xt_336x256_6_8mm.html}}

\addtocounter{footnote}{14}
