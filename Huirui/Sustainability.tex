...
Finally, the project complies with relevant legal and ethical standards. As detailed in Table~\ref{tab:risk_register_ground_operator} on risk assessment, we work closely with local authorities and communities to ensure compliance with aviation laws, safety protocols, and public privacy expectations. All custom hardware components used in the drone platform are RoHS compliant~\ref{sub_section:tgt_custom_hardware_intro}. By adhering to these standards, the project maintains responsible engineering practices while supporting inclusive and lawful deployment.